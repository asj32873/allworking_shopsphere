jest.mock("../../src/controllers/issue.controller", () => ({
...
jest.mock("../../src/validators/issue", () => ({
...
describe("support routes", () => {
  ...
  beforeEach(() => {
    ...
    jest.isolateModules(() => {
      ...
      controller = require("../../src/controllers/issue.controller");
      auth = require("../../src/middleware/auth");
      common = require("@shopsphere/common");
      validate = require("../../src/validators/issue");
    });
